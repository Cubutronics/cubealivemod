...
public class GirlfriendGUIMain extends Screen {
    ...
    public GirlfriendGUIMain(ITextComponent titleIn) {
        super(titleIn);
    }
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        girlfriend_name = girlfriend.getCustomName().getString();
        this.drawSizeString(this.font,girlfriend_name,(int)(halfW-(girlfriend_name.length()*4.5)),halfH-80,0xFFFFFF,2F);
    ...
    protected void init() {
        ...
        this.addButton(new ExtendedButton(halfW-80, halfH-10, 170, 20, I18n.format("Commands"),
                $ -> {
                    GirlfriendGUICommands girlfriendGUICommands = new GirlfriendGUICommands(new StringTextComponent("GUI"));
                    girlfriendGUICommands.setPlayer(player);
                    girlfriendGUICommands.setGirlfriend(girlfriend);
                    Minecraft.getInstance().displayGuiScreen(girlfriendGUICommands);
                }
        ));
        this.addButton(new ExtendedButton(halfW-80, halfH+20, 170, 20, I18n.format("Settings"),
                $ -> {
                    GirlfriendGUISettings girlfriendGUISettings = new GirlfriendGUISettings(new StringTextComponent("GUI"));
                    girlfriendGUISettings.setPlayer(player);
                    girlfriendGUISettings.setGirlfriend(girlfriend);
                    Minecraft.getInstance().displayGuiScreen(girlfriendGUISettings);
                }
        ));
